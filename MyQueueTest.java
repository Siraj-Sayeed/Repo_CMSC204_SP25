...
public class MyQueueTest {
	...
	public void testDequeueStudent() {
		...
		assertEquals((Double)10.0, doubleQ.dequeue());
		
		doubleQ.enqueue(40.0);
		
		assertEquals((Double)20.0, doubleQ.dequeue());
	...
	public void testEnqueueStudent() {
		...
		assertTrue(doubleQ.enqueue(10.0));
		assertTrue(doubleQ.enqueue(20.0));
		assertTrue(doubleQ.enqueue(30.0));
		doubleQ.dequeue();
		assertTrue(doubleQ.enqueue(40.0));
